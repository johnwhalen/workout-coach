        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="mt-16 lg:mt-32">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-6 lg:mb-8 max-w-lg leading-relaxed">
              ...
              adaptive workouts based on how you&apos;re feeling, and smart tracking that learns
              your patterns.
            </p>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-12 lg:py-20">
        <div className="text-center mb-10 lg:mb-16">
          ...
          <p className="text-base md:text-lg text-gray-300 max-w-2xl mx-auto">
            AI-powered coaching that adapts to your energy, tracks your progress, and helps you
            build strength
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {[
            ...
            },
            {
              ...
              description:
                "Smart weight recommendations based on your last performance. +2.5-5 lbs when you're ready.",
            ...
            },
            {
              ...
              description:
                "Full-body workouts with efficient superset pairings: Bench + Rows, Squats + RDLs, and more.",
            ...
            },
            {
              ...
              description:
                "Visual weight progression, personal records, and consistency tracking over time.",
            ...
            },
            {
              ...
              description:
                '"Did 3 sets of bench at 25 lbs, felt easy" - your coach understands and logs everything.',
            ...
            >
              ...
              <div className="text-xs lg:text-sm text-amber-400 font-medium">
                → {feature.benefit}
              </div>
            </div>
          ))}
