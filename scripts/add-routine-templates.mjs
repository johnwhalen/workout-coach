...
const templates = [
  ...
  },
  {
    ...
    exercises: [
      // Upper
      "Bench Press", "Overhead Press", "Rows", "Pull-Ups", "Lateral Raises", "Bicep Curls", "Tricep Extensions",
      // Lower
      "Squats", "Romanian Deadlifts", "Leg Press", "Hamstring Curls", "Calf Raises",
      // Push
      "Incline Press", "Dumbbell Press", "Chest Flyes", "Shoulder Press", "Tricep Dips",
      // Pull
      "Deadlift", "Barbell Rows", "Lat Pulldown", "Face Pulls", "Hammer Curls",
      // Legs
      "Front Squats", "Lunges", "Leg Extensions", "Glute Bridges"
    ]
  },
  {
    ...
    exercises: [
      // Push
      "Flat Bench Press", "Incline Dumbbell Press", "Cable Flyes", "Overhead Press", "Lateral Raises", "Tricep Pushdowns",
      // Pull
      "Deadlift", "Bent Over Rows", "Lat Pulldown", "Face Pulls", "Barbell Curls", "Hammer Curls",
      // Legs
      "Squats", "Leg Press", "Romanian Deadlifts", "Leg Curls", "Calf Raises", "Lunges"
    ]
  }
];
