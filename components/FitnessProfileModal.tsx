                ...
                <div className="space-y-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <TextInput
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, currentWeight: e.target.value })}
                            required
                        ...
                        <TextInput
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, goalWeight: e.target.value })}
                            required
                            className="text-white"
                            styles={{
                                input: {
                        ...
                        <Select
                            ...
                            onChange={(value: string | null) => setFormData({ ...formData, fitnessGoal: value || "" })}
                            required
                            className="text-white"
                            styles={{
                                input: {
